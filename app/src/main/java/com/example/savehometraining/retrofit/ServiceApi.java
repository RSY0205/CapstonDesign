...
public interface ServiceApi {
    ...
    Call<RoutineRecommendResponse> RoutineRecommend(@Body RoutineRecommendData data);

    @POST("/user/routine/loadexcerciseinfo")
    Call<LoadExerciseInfoResponse> LoadExceriseInfo(@Body LoadExceriseInfoData data);

    @POST("/user/routine/RecommendExericse")
    Call<RecommendExerciseResponse> RecommendExercise(@Body RecommendExerciseData data);

    @POST("/user/routine/FavoriteExericse")
    Call<FavoriteExerciseResponse> FavoriteExercise(@Body FavoriteExerciseData data);

    @POST("/user/routine/Statistic")
    Call<StatisticResponse> Statistic(@Body StatisticData data);

    @POST("/user/routine/Statistic/Excerise")
    Call<StatisticExResponse> StatisticEx(@Body StatisticExData data);

    @POST("/user/routine/Statistic/Part")
    Call<StatisticPartResponse> StatisticPart(@Body StatisticPartData data);
}
